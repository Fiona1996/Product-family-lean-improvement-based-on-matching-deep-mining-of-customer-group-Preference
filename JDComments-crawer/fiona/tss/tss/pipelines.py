...
class TssPipeline(object):
    ...
    def data_clear(self, commons):
        ...
        stopwords = pd.read_csv("C:/Users/27438/PycharmProjects/fiona/tss/asset/chineseStopWords.txt", index_col=False,
    ...
    def make_wordclouds(self, commons):
        ...
        msk = np.array(Image.open(path.join(d, "C:/Users/27438/PycharmProjects/fiona/tss/asset/me.jpg")))
