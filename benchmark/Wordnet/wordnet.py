...
data = pd.read_csv("C:/Users/黎月明/Desktop/word_bag/test_word_bag/test.csv")
...
for i, (word1, word2) in enumerate(wordsList):
    print
    "process #%d words pair [%s,%s]" % (i, word1, word2)
    count = 0
    ...
    for synset1 in synsets1:
        for synset2 in synsets2:
            ...
            if score is not None:
                ...
                print
                synset1, "path_similarity", synset2, "is None", "==" * 10
...
(pd.DataFrame(submitData)).to_csv("wordnet.csv", index=False, header=["Word1", "Word2", "OriginSimilarity", "PredSimilarity"])
